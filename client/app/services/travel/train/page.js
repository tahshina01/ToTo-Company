...
export default function TravelPage() {
    ...
    return (
      ...
      <div className={styles.heroSection}>
          <h1>Find Your Destined Train</h1>
          <p>Search hundreds of Train Operators and find the best price for your journey</p>
      </div>
        ...
        <div className={styles.container}>
            <div className={styles.priceHeader}>
                ...
                <div className={styles.priceRange}>
                    <p>
                        The least expensive trains for similar trips to {toLocation} usually cost between ${Math.min(...priceTimelineData.map(d => d.price))}–${Math.max(...priceTimelineData.map(d => d.price))}.
