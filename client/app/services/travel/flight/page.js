...
export default function TravelPage() {
    ...
    return (
      ...
      <div className={styles.heroSection}>
          ...
          <p>Search hundreds of Airlines and find the best price for your journey</p>
      </div>
        ...
        <div className={styles.container}>
            <div className={styles.priceHeader}>
                ...
                <div className={styles.priceRange}>
                    <p>
                        The least expensive flights for similar trips to {toLocation} usually cost between ${Math.min(...priceTimelineData.map(d => d.price))}–${Math.max(...priceTimelineData.map(d => d.price))}.
