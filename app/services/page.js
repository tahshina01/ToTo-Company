...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'Stay at the best hotels and resorts that offer comfort and luxury.',
      link: '/services/accommodation', // Link to more details
    },
    {
      title: 'Landmarks',
      imageUrl: '/landmark.jpg', // Replace with your image URL
      description: 'Discover the most iconic landmarks and attractions that make every trip unforgettable.',
